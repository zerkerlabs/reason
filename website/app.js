  ...
  return `<main class="zr-shell">
    ...
    <section class="zr-demo" id="zr-demo">
      ...
      <div class="zr-lab">
        ...
        <div class="zr-verification-bar">${icons.shield}<div><b data-zr-foot>Independent verification passed</b><span data-zr-source>Loaded from a certificate generated by Zerker Reason</span></div><a data-zr-certificate-link href="data/reason/authorized-certificate.json" download>Download certificate ${icons.arrow}</a></div>
...
<small>Exit 0 · certificate independently verified</small></pre></div></details>
  ...
  <b>"proof_digest"</b>: <em>"sha256:ba4bd960b803..."</em>
      ...
      <div class="zr-json-actions"><a data-zr-request-link href="data/reason/authorized-request.json" download>Download request ${icons.arrow}</a><a data-zr-verification-link href="data/reason/authorized-verification.json" download>Download verification ${icons.arrow}</a></div>
    </section>
...
async function loadScenario(key) {
  ...
  try {
    ...
    if (!data) {
      const base = `data/reason/${key}`;
      const manifestResponse = await fetch("data/reason/manifest.json");
    ...
    const links = {
      "[data-zr-certificate-link]": `data/reason/${key}-certificate.json`,
      "[data-zr-request-link]": `data/reason/${key}-request.json`,
      "[data-zr-verification-link]": `data/reason/${key}-verification.json`,
    };
